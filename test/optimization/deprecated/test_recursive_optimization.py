...
from test.optimization.deprecated import QiskitOptimizationDeprecatedTestCase
...
class TestRecursiveMinEigenOptimizer(QiskitOptimizationDeprecatedTestCase):
