...
import unittest
import warnings
from test.finance.deprecated import QiskitFinanceDeprecatedTestCase
import numpy as np
...
@ddt
class TestEuropeanCallOption(QiskitFinanceDeprecatedTestCase):
...
@ddt
class TestFixedIncomeAssets(QiskitFinanceDeprecatedTestCase):
